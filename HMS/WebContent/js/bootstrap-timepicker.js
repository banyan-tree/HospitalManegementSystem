  ...
  Timepicker.prototype = {
    ...
    place : function() {
      ...
      if (this.orientation.x !== 'auto') {
        ...
        // auto x orientation is best-placement: if it crosses a window edge,
		// fudge it sideways
        // Default to left
    ...
    showWidget: function() {
      ...
      $(document).on('mousedown.timepicker, touchend.timepicker', function (e) {
        ...
        // The element the timepicker is invoked on is the input but it has a
		// sibling for addon/button.
